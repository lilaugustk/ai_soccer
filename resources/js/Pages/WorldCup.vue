                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-[32px] border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden">
                                        <div class="overflow-x-auto">
                                            <table class="w-full text-left">
                                                <thead>
                                                    <tr class="bg-gray-50/50 dark:bg-gray-700/20 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">
                                                ...
                                                <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                                                    <tr v-for="(team, idx) in (props.groups?.[selectedGroupId] || [])" 
                                                        :key="team.name"
                                                        ...
                                                        <td class="px-6 py-5">
                                                            <div class="flex items-center gap-3">
                                                                ...
                                                                <span class="text-xs font-bold text-gray-700 dark:text-gray-200 uppercase tracking-wide">{{ team.name }}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="px-6 py-5 text-center text-xs font-black text-emerald-600">{{ team.pts }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <h3 class="text-sm font-black text-gray-800 dark:text-gray-100 uppercase tracking-[0.2em]">Lịch thi đấu Bảng {{ selectedGroupId }}</h3>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        <div v-for="match in (groupMatches[selectedGroupId] || [])" :key="match.id"
                                            ...
                                            <div class="px-4 py-2 bg-gray-50/50 dark:bg-gray-700/20 border-b border-gray-50 dark:border-gray-700 flex justify-between items-center">
                                                ...
                                                <span class="text-[9px] font-black text-emerald-600 uppercase tracking-tighter">Bảng {{ selectedGroupId }}</span>
                                            </div>
                                            ...
                                            <div class="p-5">
                                                ...
                                                <div class="grid grid-cols-7 items-center gap-2 mb-4">
                                                    <div class="col-span-3 flex flex-col items-center gap-2">
                                                        ...
                                                        <span class="text-[10px] font-bold text-gray-700 dark:text-gray-200 uppercase text-center truncate w-full">{{ match.home }}</span>
                                                    </div>
                                                    ...
                                                    <div class="col-span-3 flex flex-col items-center gap-2">
                                                        ...
                                                        <span class="text-[10px] font-bold text-gray-700 dark:text-gray-200 uppercase text-center truncate w-full">{{ match.away }}</span>
                                                    </div>
                                                </div>
                            ...
                            <div v-else class="space-y-10">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <h3 class="text-sm font-black text-gray-800 dark:text-gray-100 uppercase tracking-[0.2em]">{{ groupList.find(s => s.id === selectedGroupId)?.name }}</h3>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    <div v-for="i in 3" :key="i"
                                        ...
                                        <div class="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-4 text-center">TBD - 00:00</div>
                                        <div class="flex items-center justify-between gap-4">
                                            ...
                                            <span class="text-lg font-black text-gray-200 dark:text-gray-700">VS</span>
                                            <div class="flex flex-col items-center gap-2 flex-1 min-w-0">
                                                <div class="w-10 h-10 rounded-full bg-gray-50 dark:bg-gray-700 p-1.5 shadow-inner">
                                                    <div class="w-full h-full rounded-full bg-gray-200 dark:bg-gray-600 animate-pulse"></div>
                                                </div>
                                ...
                                <div class="p-10 text-center bg-gray-50/50 dark:bg-gray-800/50 rounded-[32px] border border-dashed border-gray-200 dark:border-gray-700">
                                    ...
                                    <button @click="activeTab = 'knockout'" class="mt-4 text-[10px] font-black text-emerald-600 uppercase tracking-widest hover:underline">Mở Bracket Map</button>
                                </div>
                            </div>
                        </div>

                        <!-- MODE 4: STADIUMS (Venue List) -->
                                ...
                                <div v-for="stadium in safeStadiums" :key="stadium.id" 
                                    ...
                                    <div class="aspect-[16/9] bg-gray-100 dark:bg-gray-700 relative overflow-hidden">
                                        ...
                                        <div class="absolute bottom-4 left-6">
                                            <h4 class="text-white font-black uppercase tracking-widest text-sm">{{ stadium.name }}</h4>
                                            <p class="text-white/70 text-[10px] font-bold uppercase">{{ stadium.city }}, {{ stadium.country }}</p>
                                        </div>
                                    </div>
                                    <div class="p-6">
                                        <div class="flex items-center justify-between">
                                            <div class="space-y-1">
                                                <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Sức chứa</span>
                                                <div class="text-lg font-black text-emerald-600 tracking-tighter">
                                                    {{ stadium.capacity?.toLocaleString() || 'TBD' }}
                                                    <span class="text-[10px] text-gray-400 font-bold ml-1 uppercase">chỗ ngồi</span>
                                                </div>
                                            </div>
                        ...
                        <div v-else-if="activeTab === 'date'" class="space-y-8">
                            <div v-for="date in sortedDates" :key="date" class="space-y-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">{{ dayjs(date).format('dddd, DD/MM/YYYY') }}</span>
                                    <div class="h-px flex-1 bg-gray-100 dark:bg-gray-800"></div>
                                </div>
                                
                                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                    <div v-for="match in matchesByDate[date]" :key="match.id"
                                         class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-4 shadow-sm hover:shadow-md transition-all">
                                        <div class="flex justify-between items-center mb-3">
                                            <span class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">{{ match.time }}</span>
                                            <span class="text-[9px] font-black text-emerald-600 uppercase">{{ match.group_name }}</span>
                                        </div>
                                        <div class="flex items-center justify-between gap-2">
                                            <div class="flex flex-col items-center gap-1 flex-1">
                                                <img :src="match.homeFlag" class="w-8 h-8 object-contain mb-1" />
                                                <span class="text-[10px] font-bold text-gray-700 dark:text-gray-200 text-center uppercase truncate w-full">{{ match.home }}</span>
                                            </div>
                                            <div class="text-[10px] font-black text-gray-300">VS</div>
                                            <div class="flex flex-col items-center gap-1 flex-1">
                                                <img :src="match.awayFlag" class="w-8 h-8 object-contain mb-1" />
                                                <span class="text-[10px] font-bold text-gray-700 dark:text-gray-200 text-center uppercase truncate w-full">{{ match.away }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center justify-between max-w-4xl mx-auto">
                                        ...
                                        <div class="flex gap-16 md:gap-32">
                                            <div v-for="round in visibleRounds" :key="'header-'+round.id" class="text-center min-w-[200px]">
                                                <h3 class="text-emerald-600 font-bold text-sm md:text-base uppercase tracking-widest">{{ round.name }}</h3>
                                            </div>
                                        </div>
                                                    ...
                                                    <div v-for="match in pair" :key="match.id" class="relative z-10 h-[90px] flex items-center">
                                                        ...
                                                        <div class="w-full bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                                                            <div class="px-3 py-1.5 bg-gray-50/50 dark:bg-gray-700/20 border-b border-gray-50 dark:border-gray-700 flex justify-between">
                                                                <span class="text-[10px] font-bold text-emerald-600 uppercase tracking-tighter">Trận {{ match.id }} • {{ match.time }} • {{ match.date }}</span>
                                                            </div>
                                                            <div class="p-3 space-y-2">
                                                                <div v-for="team in ['home', 'away']" :key="team" class="flex items-center justify-between">
                                                                    <div class="flex items-center gap-2">
                                                                        ...
                                                                        <span class="text-[11px] font-bold text-gray-700 dark:text-gray-200 uppercase truncate max-w-[130px]">{{ match[team] }}</span>
                                                                    </div>
...
const dummyGroups = {
    'A': [
        ...
        { name: 'Korea Republic', flag: 'https://flagcdn.com/kr.svg' },
        { name: 'Czechia', flag: 'https://flagcdn.com/cz.svg' },
    ],
    'B': [
        { name: 'Canada', flag: 'https://flagcdn.com/ca.svg' },
        { name: 'Bosnia and Herz.', flag: 'https://flagcdn.com/ba.svg' },
    ...
    'C': [
        ...
        { name: 'Scotland', flag: 'https://flagcdn.com/gb-sct.svg' },
    ],
    'D': [
        { name: 'USA', flag: 'https://flagcdn.com/us.svg' },
        { name: 'Paraguay', flag: 'https://flagcdn.com/py.svg' },
        { name: 'Australia', flag: 'https://flagcdn.com/au.svg' },
        { name: 'Türkiye', flag: 'https://flagcdn.com/tr.svg' },
    ],
    'E': [
    ...
    'G': [
        ...
        { name: 'IR Iran', flag: 'https://flagcdn.com/ir.svg' },
    ...
    'K': [
        ...
        { name: 'Congo DR', flag: 'https://flagcdn.com/cd.svg' },
